...
import videoMain    from '../assets/completo.mov';
import videoIntro   from '../assets/entrada.mov';
...
export default function Hero() {
  ...
  const [showRestart, setShowRestart] = useState(false); // botón post-celebración
  ...
  const handleEnded = () => {
    if (phase === 'main') {
      ...
      // entrada.mov terminó → volver a 'unlocked' si ya se desbloqueó antes,
      // o a 'main' si nunca terminó el principal (reinicia completo)
  ...
  const restartVideo = () => {
    if (phase === 'unlocked') {
      // Reinicia completo desde el principio (vuelve a bloquear)
      setCurrentSrc(videoMain);
      setPhase('main');
    }
    setVideoKey((k) => k + 1);
  ...
  /* ── "Celebra con nosotros" → reproducir celebración ── */
    ...
    <>
        ...
        <div className="clip-scene">
          ...
          <div className="video-frame">
            <div className="video-frame__inner">
              ...
              {/* Botones — solo visibles en fase 'unlocked' */}
              <div className={`video-ui ${showButtons ? 'video-ui--visible' : ''}`}>

                {/* Botón principal en la punta del dedo */}
                <button
                  id="btn-celebra"
                ...
                {/* Grupo de control inferior derecho */}
      ...
      <section className="hero-text" id="bienvenida">
        ...
        <div className="hero__content">
          ...
          <p className="hero__subtitle">Recibe el bautismo</p>
